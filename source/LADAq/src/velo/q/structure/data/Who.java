...
public class Who extends Source {
    ...
    public static DataPoint findIndicator() {
        class findIndicator extends DataPoint {
            ...
            public Object fetch(Object[] p) {
                ...
                JSONObject object = res.getJsonBody();
                JSONArray data = (JSONArray) object.get("values");
                return object;
            }
        }
    ...
    public static DataPoint indicator() {
        class indicator extends DataPoint {
            ...
            @Override
            public Object fetch(Object[] p) {
                String code = null, name = null, indicator = (String) p[0], country = p.length < 2 ? null : (p[1].equals("|") ? null : ((String) p[1])),
            ...
            private Double[][] parseData(JSONArray array) {
                ...
                for (Double yy : map.keySet()) {
                    ArrayList<Double> data = map.get(yy);
                    Double sum = 0.0, mean;
                    for (Double d : data) {
                        sum += d;
                    }
